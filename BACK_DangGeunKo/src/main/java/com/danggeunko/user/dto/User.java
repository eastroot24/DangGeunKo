...
public class User {
	...
	public User(int userId, String userName, String nickname, String userEmail, String userPassword, String gender,
			int age, String region, LocalDateTime createdAt, LocalDateTime updatedAt, String profileImg,
			double prefDistance, String prefDifficulty) {
		super();
		this.userId = userId;
	...
	public String toString() {
		return "User [userId=" + userId + ", userName=" + userName + ", nickname=" + nickname + ", userEmail="
				...
				+ region + ", createdAt=" + createdAt + ", updatedAt=" + updatedAt + ", profileImg="
				+ profileImg + ", prefDistance=" + prefDistance + ", prefDifficulty=" + prefDifficulty + "]";
	}
