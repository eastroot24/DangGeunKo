...
(1, '여의도 샛강 생태공원 코스', '서울특별시', '영등포구', '국회의사당역', '샛강생태공원', 
 7.5, 45.0, 6.0, 1, '런린이', '평탄하고 뷰가 좋은 강변 코스입니다.', TRUE, TRUE, 4.5, 320),
(2, '남산타워 힐 트레이닝', '서울특별시', '중구', '남산 순환버스 정류장', '남산 팔각정', 
 8.0, 60.0, 7.5, 2, '런고수', '경사가 있어 훈련에 좋은 코스, 야경이 매우 아름다움', FALSE, TRUE, 4.8, 510),
(3, '올림픽공원 호수 순환', '서울특별시', '송파구', '평화의 문', '몽촌토성역', 
 5.2, 30.0, 5.7, 1, '런린이', '가볍게 뛰기 좋은 공원 내부 코스, 벚꽃 명소', TRUE, TRUE, 4.2, 150),
(4, '북악스카이 힐 코스', '서울특별시', '종로구', '팔각정 입구', '북악산 매표소', 
 12.0, 90.0, 7.5, 2, '런고수', '고강도 훈련을 위한 최적의 힐 코스', FALSE, FALSE, 4.9, 600),
(5, '광안리 해변 런', '부산광역시', '수영구', '광안리 해변 입구', '민락수변공원', 
 6.8, 40.0, 5.9, 1, '런린이', '부산의 대표적인 해변 러닝 코스', FALSE, TRUE, 4.7, 720),
(6, '해운대 달맞이 길', '부산광역시', '해운대구', '해월정 입구', '달맞이 고개 정상', 
 4.5, 45.0, 10.0, 2, '런고수', '짧지만 경사가 급격한 힐 트레이닝', FALSE, FALSE, 4.6, 380),
(7, '온천천 시민공원 평지', '부산광역시', '동래구', '온천천 공원 입구', '세병교', 
 11.0, 70.0, 6.3, 1, '러너', '긴 거리를 안정적으로 뛸 수 있는 평지 코스', TRUE, TRUE, 4.4, 300),
(8, '대구 신천 둔치 장거리', '대구광역시', '수성구', '신천시장', '동신교', 
 9.0, 55.0, 6.1, 1, '러너', '대구 도심을 가로지르는 긴 강변 코스', TRUE, TRUE, 4.4, 270),
(9, '송도 센트럴파크 야간 런', '인천광역시', '연수구', '센트럴파크 정문', '보트하우스', 
 4.2, 25.0, 6.0, 1, '런린이', '도심 속 아름다운 공원 러닝, 야경이 멋짐', TRUE, TRUE, 4.5, 250),
(10, '강화도 해안 드라이브 코스', '인천광역시', '강화군', '동막 해수욕장', '분오리돈대', 
 15.0, 100.0, 6.7, 3, '런고수', '장거리 지구력 훈련에 적합한 해안 코스', FALSE, FALSE, 4.0, 180),

-- 11-20: 경기도 지역 데이터
(1, '일산 호수공원 트랙', '경기도', '고양시 일산동구', '호수공원 정문', '노래하는 분수대', 
 3.5, 20.0, 5.7, 1, '런린이', '짧고 안전하며 접근성이 좋은 코스', TRUE, TRUE, 4.1, 120),
(2, '분당 탄천 합수부', '경기도', '성남시 분당구', '탄천종합운동장', '정자역 부근', 
 8.5, 50.0, 5.9, 1, '러너', '빠른 페이스를 유지하기 좋은 평탄한 코스', FALSE, TRUE, 4.3, 350),
(3, '수원 화성 성곽길', '경기도', '수원시 팔달구', '화서문', '장안문', 
 5.8, 40.0, 6.9, 2, '러너', '역사적인 장소를 따라 뛰는 코스 (계단 주의)', TRUE, TRUE, 4.7, 420),
(4, '용인 에버랜드 주변 임도', '경기도', '용인시 처인구', '마성 IC 부근', '에버랜드 주차장', 
 13.0, 95.0, 7.3, 2, '런고수', '비포장도로가 일부 포함된 트레일 코스', FALSE, FALSE, 4.4, 230),
(5, '과천 서울대공원 외곽', '경기도', '과천시', '대공원역 2번 출구', '서울랜드 정문', 
 7.0, 48.0, 6.8, 2, '러너', '완만한 경사가 있는 쾌적한 환경의 코스', TRUE, TRUE, 4.2, 290),
(6, '구리 한강 시민공원', '경기도', '구리시', '구리 타워', '토평교', 
 10.0, 62.0, 6.2, 1, '러너', '한강변을 따라 길게 뻗은 평탄 코스', FALSE, TRUE, 4.1, 170),
(7, '김포 아라마루 전망대 순환', '경기도', '김포시', '아라뱃길 김포여객터미널', '아라마루 전망대', 
 6.0, 40.0, 6.7, 2, '러너', '바람이 시원하며 시야가 트인 코스', FALSE, FALSE, 4.5, 210),
(8, '안양천 합수부', '경기도', '안양시 만안구', '안양대교', '안양천 합수부', 
 9.2, 55.0, 6.0, 1, '러너', '자전거 도로와 분리되어 안전한 하천변 코스', TRUE, TRUE, 4.3, 330),
(9, '파주 헤이리 예술마을 외곽', '경기도', '파주시', '헤이리 게이트 1', '프로방스 마을', 
 5.0, 30.0, 6.0, 3, '런린이', '예쁜 마을 주변을 도는 코스', TRUE, FALSE, 3.9, 140),
(10, '평택호 관광단지 트랙', '경기도', '평택시', '평택호 관광지 주차장', '평택호 전망대', 
 7.2, 45.0, 6.2, 1, '러너', '호수를 바라보며 뛰는 쾌적한 코스', FALSE, TRUE, 4.0, 200),

-- 21-30: 강원도, 충청도, 전라도, 경상도, 제주도 지역 데이터
(1, '강릉 경포호 벚꽃 런', '강원도', '강릉시', '경포호 주차장', '경포대', 
 4.7, 28.0, 6.0, 1, '런린이', '봄에 특히 아름다운 호수 순환 코스', TRUE, TRUE, 4.6, 480),
(2, '춘천 의암호 자전거길', '강원도', '춘천시', '공지천 조각공원', '의암호 스카이워크', 
 10.5, 75.0, 7.1, 2, '런고수', '완만한 오르막이 있는 긴 거리 코스', FALSE, FALSE, 4.4, 260),
(3, '천안 독립기념관 주변', '충청남도', '천안시 동남구', '독립기념관 정문', '겨레의 탑', 
 8.8, 60.0, 6.8, 2, '러너', '역사적 의미가 있는 넓은 공원 주변 코스', TRUE, TRUE, 4.2, 220),
(4, '청주 무심천변 런', '충청북도', '청주시 상당구', '무심천 롤러스케이트장', '청남교', 
 7.0, 42.0, 6.0, 1, '러너', '청주시를 가로지르는 하천변 평탄 코스', TRUE, TRUE, 4.3, 190),
(5, '전주 한옥마을 외곽', '전라북도', '전주시 완산구', '경기전 앞', '남천교', 
 3.8, 22.0, 5.8, 3, '런린이', '도심 속에서 가볍게 뛰는 짧은 코스', TRUE, TRUE, 3.9, 140),
(6, '광양 백운산 등산로', '전남', '광양시', '마이산 등산로 입구', '봉우재', 
 18.0, 130.0, 7.2, 2, '런고수', '장거리 힐 트레일 (난이도 높음)', FALSE, FALSE, 4.7, 310),
(7, '경주 보문호 순환 코스', '경북', '경주시', '보문단지 입구', '보문호 선착장', 
 7.8, 48.0, 6.1, 1, '런린이', '관광객이 많은 평탄한 호수 주변 코스', TRUE, TRUE, 4.5, 390),
(8, '포항 영일대 해상누각 런', '경북', '포항시 남구', '영일대 해수욕장', '포항제철소 야경', 
 5.0, 30.0, 6.0, 1, '런린이', '바다를 따라 뛰는 상쾌한 코스', TRUE, TRUE, 4.1, 100),
(9, '창원 주남저수지 트레일', '경남', '창원시 의창구', '주남저수지 탐방로', '주남저수지 관리소', 
 6.0, 42.0, 7.0, 2, '러너', '자연 친화적이지만 길이 고르지 않은 코스', FALSE, FALSE, 4.3, 160),
(10, '제주 해안도로 동부', '제주특별자치도', '제주시', '함덕 해수욕장', '김녕 해수욕장', 
 20.0, 140.0, 7.0, 3, '런고수', '아름다운 풍경, 장거리 훈련 코스', FALSE, FALSE, 4.8, 650);
