<template>
    <div class="coach-btn-wrapper">
        ...
        <CoachModal v-if="isCoachOpen && user" :user="user" @close="isCoachOpen = false" />
    </div>
</template>
